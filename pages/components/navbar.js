...
export default function Navbar ()
{
  ...
  <div class="flex items-center">
      <Image src={"/ribbon-svgrepo-com.svg"} alt= {"logo"} width={40} height={40}></Image>
  </div>
  <div class="flex md:order-2">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      ...
      <li>
          <a href="#" class="block  pl-3 pr-4 text-gray-900 rounded hover:bg-blue-950 md:hover:bg-transparent md:hover:text-blue-950 md:p-0 md:dark:hover:text-blue-950 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Home</a>
        </li>
        <li>
          <a href="#" class="block  pl-3 pr-4 text-gray-900 rounded hover:bg-blue-950 md:hover:bg-transparent md:hover:text-blue-950 md:p-0 md:dark:hover:text-blue-950 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Women</a>
        </li>
        <li>
        ...
        <li>
          <a href="#" class="block  pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-950 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Shoes</a>
        </li>
      </ul>
    </div>
  </div>
